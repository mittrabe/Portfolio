...
def createLocations(matrix, dayData, numDrivers):
    ...
    #In this order: locationIndex, locationID, startTime, endTime, unavailableStart, unavailableEnd, serviceTime, locationType, pounds, distances
    locations = []
...
def createTrucks(numDrivers, maxCapacity, warehouse):
    ...
    for i in range(numDrivers):
        newRoute = [warehouse]
        newTruck = truckClass.Truck("Driver " + str(i+1), newRoute, 0, maxCapacity, 0)
