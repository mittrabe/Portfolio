...
#=====================
        ...
        def endTurn(self):
            controller.showFrame("Chess Screen", self.boardState)
        #END TURN
        ...
        if len(boardState) > 0:
            for row in range(8):
                    for col in range(8):
                        ...
                        self.boardState.append(ChessSquare(board, details[0],details[1],details[2],boardWidth*1.4,boardHeight*1.4,isActive, self.boardState))
