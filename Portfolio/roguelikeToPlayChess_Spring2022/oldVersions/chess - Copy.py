...
###########################################
    def __init__(self, *args, **kwargs):
        ...
        for F in (TitleScreen, MenuScreen, ChessGame):
            frame = F(window, self)
...
#-------------------
        ...
        for square in chessSquares:
            square['command'] = lambda square=square: function(square) 
        

        def resetSquares():
            for square in chessSquares:
                square['style'] = square.setStyle()
        ...
        def function(event):
            resetSquares() #This resets all the squares to their original color before highlighting squares again.
