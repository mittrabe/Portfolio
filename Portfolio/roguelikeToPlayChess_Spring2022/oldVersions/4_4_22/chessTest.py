...
#                TO DO
###########################################
# Implement Chess CPU AI
# Implement CPU Piece Generation
# Implement Custom piece abilities
# Finalize Custom Piece art
# Implement Shop Pool Upgrade Message
# Implement Database/login page
# Finish creating piece tooltips 
# Implement piece Tooltips in shop
# Implement win/lose 
# Implement check/checkmate
# Implement piece graveyard & previous move displayer
# Implement Freezing pieces in shop
...
###########################################
    def __init__(self, *args, **kwargs):
        ...
        for F in (TitleScreen, LoginScreen, MenuScreen, ShopScreen, ChessScreen):
            if F == ChessScreen:
                ...
                boardState = []
                #[1]self, [2]parent, [3]controller, [4]boardState, [5]numCoins, [6]maxNumCoins, [7]numLives, [8]numWins, [9] numTurns, [10]pieceValue, [11]maxPieceValue, [12]numRows, [13]playerColor
                frame = F(self.window, self, boardState, 10, 10, 5, 5, 0, 0, 10, 2, 'black', self.pieceState)  
            else:
    ...
    def showFrame(self, cont, *args):
        ...
        if cont == 'Chess Screen':
            ...
            self.frames[frameIndex] = ShopScreen(self.window, self, args[0], 10, 10, 5, 0, self.frames[frameIndex].getNumTurns()+1, self.frames[frameIndex].getPiecesValue(), self.frames[frameIndex].getMaxPiecesValue(), self.frames[frameIndex].getNumRows(), 'black', self.pieceState)
