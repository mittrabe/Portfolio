...
class ChessPiece:
    ...
    def setValue(self, pieceType):
        ...
        value2 = [2,'Pikeman','Trojan','Martyr','AltarBoy','Donkey'] #To be Added: Priest
        value3 =[3,'Bishop','Knight','Thief','General','LandMine','Club']
        ...
        value7 = [7,'Diplomat'] #To be added: Princess, Prince
        value8 = []
        value9 = [9,'Queen']
    ...
    def __init__(self, pieceName, pieceType, timesMoved, piecesTaken, lastPieceTaken, pieceColor, gamesPlayed):
