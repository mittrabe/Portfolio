...
###########################################
    def __init__(self, *args, **kwargs):
        ...
        for F in (TitleScreen, LoginScreen, MenuScreen, ShopScreen, ChessScreen):
            if F == ChessScreen:
                ...
                frame = F(self.window, self, boardState, 10, 10, 5, 5, 0, 10, 2, 'black', self.pieceState)  
            else:
    ...
    def showFrame(self, cont, *args):
        ...
        if cont == 'Chess Screen':
            ...
            #[1]self, [2]parent, [3]controller, [4]boardState, [5]numCoins, [6]maxNumCoins, [7]numLives, [8]numWins, [9]pieceValue, [10]maxPieceValue, [11]numRows, [12]playerColor
            self.frames[frameIndex] = ShopScreen(self.window, self, args[0], 10, 10, 5, 0, self.frames[frameIndex].getPiecesValue(), self.frames[frameIndex].getMaxPiecesValue(), self.frames[frameIndex].getNumRows(), 'black', self.pieceState)
