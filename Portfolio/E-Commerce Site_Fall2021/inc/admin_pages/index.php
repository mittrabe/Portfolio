    ...
    <body>
        ...
        <div id="contactForm">
            <form id="contactFields" onsubmit="CheckRequiredSubmissions();" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" name="contactFields" method="post">  
                ...
                <input placeholder="Password*" type="text" id="password" name="password" class="requiredElement <?php echo $passwordError; ?>"/>
                <input placeholder="Confirm Password*" type="text" id="confirmPassword" name="confirmPassword" class="requiredElement <?php echo $confirmPasswordError; ?>"/>
